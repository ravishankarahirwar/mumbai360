...
public class MetroMonoAdapter extends RecyclerView.Adapter<StationNameViewHolder> {
    private List<Station> mValues;
    private OnStationSelect mListener;

    public MetroMonoAdapter(List<Station> values, OnStationSelect listener) {
        this.mValues = values;
    ...
    public StationNameViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
               .inflate(R.layout.item_metro_mono, parent, false);
